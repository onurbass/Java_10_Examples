...
//		return "Forvet [bitiricilik=" + bitiricilik + ", kafaVurusu=" + kafaVurusu + ", ilkDokunus=" + ilkDokunus
//				+ ", getNo()=" + getNo() + ", getHiz()=" + getHiz() + ", getPas()=" + getPas() + ", getTopSurme()="
//				+ getTopSurme() + ", getSut()=" + getSut() + ", getDayaniklilik()=" + getDayaniklilik()
//			+ ", getMevki()=" + getMevki() + ", getIsim()=" + getIsim() + "]";
//	}
